...
DROP SEQUENCE t_author;
DROP SEQUENCE t_book;
...
*/
CREATE TABLE t_book(book_id NUMBER(10) PRIMARY KEY,
                    title VARCHAR2(100),
                    pubs VARCHAR2(100),
                    pub_date DATE,
...
CREATE TABLE t_author(author_id NUMBER(10) PRIMARY KEY,
...
INSERT INTO t_book
VALUES(6,'오직 두사람','문학동네','2017-05-04',5);
INSERT INTO t_book
VALUES(7,'26년','재미주의','2012-02-04',4);
INSERT INTO t_book
VALUES(8,'삼체','자음과모음','2020-07-06',6);
INSERT INTO t_book
...
FROM t_book b LEFT OUTER JOIN t_author a ON b.author_id = a.author_id
ORDER BY title DESC;
